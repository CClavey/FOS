        ...
        while($row1 = $result1->fetch_assoc())
		{
			...
			?>
				...
				<td>
					...
					<br><br>Topping 1:&ensp;&ensp;<?php echo $row1['topping1']; ?>
					<br><br>
					Topping 2:&ensp;&ensp;<input type = "text" name = "top2" id = "top2<?php echo $total?>" value = "" readonly/>

					<br><br><button style="background-color: #ff6347;" type="button" onclick = "addToCart('<?php echo $row1['dishName'], ": $", $row1['price']; ?>')">Add to Cart!</button><br><br>
